...
![Scatter plot of per-pupil spending versus math scores by urbanicity
using theme_aib](reference/figures/README-theme-aib-1.png)

### `theme_aib_grid()` — Data-Dense

Same as
[`theme_aib()`](https://andrewmcamp.github.io/ggaib/reference/theme_aib.md)
with light gray major gridlines for data-dense plots.
...
![Line chart showing a narrowing achievement gap between higher-income
and lower-income students over time using
theme_aib_grid](reference/figures/README-theme-grid-1.png)
...
![Bar chart of K-12 enrollment by school type using
theme_aib_slide](reference/figures/README-theme-slide-1.png)
...
![Choropleth map of per-pupil spending by U.S. state using
theme_aib_map](reference/figures/README-theme-map-1.png)
...
continuous navy-to-sky
gradient](reference/figures/README-scale-continuous-1.png)
