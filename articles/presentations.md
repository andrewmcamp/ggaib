...
![](presentations_files/figure-html/size-default-1.png)
...
![](presentations_files/figure-html/size-presentation-1.png)
...
| Context            | Theme call                                                                  |
|--------------------|-----------------------------------------------------------------------------|
| Print / report     | [`theme_aib()`](https://andrewmcamp.github.io/ggaib/reference/theme_aib.md) |
